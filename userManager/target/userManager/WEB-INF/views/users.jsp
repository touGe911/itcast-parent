...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/user/page/user-add'" style="width:600px;height:400px;padding:10px;">
        The window content.
</div>
	<div id="userEdit" class="easyui-window" title="编辑会员信息" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/user/page/user-edit'" style="width:600px;height:400px;padding:10px;">
		The window content.
	</div>
    ...
    handler:function(){
        ...
        $('#userEdit').window({
            onLoad:function () {
                var userList = $("#userList");
                var sels = userList.datagrid("getSelections");
                var now = new Date(sels[0].birthday);
                sels[0].birthday = now.format("yyyy-MM-dd");
